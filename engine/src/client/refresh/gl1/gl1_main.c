...
R_RenderView(refdef_t *fd)
{
...

	{
		...
		static cvar_t *kaios_debug_gl1occl;

		if (!kaios_debug_gl1occl)
		{
			kaios_debug_gl1occl = ri.Cvar_Get("kaios_debug_gl1occl", "0", CVAR_ARCHIVE);
		}

		if (kaios_debug_gl1occl->value && (kaios_occl_frame++ % 60) == 0)
		{
